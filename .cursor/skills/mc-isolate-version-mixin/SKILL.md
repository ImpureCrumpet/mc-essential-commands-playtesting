...
triggers:
  - add a Fabric mixin to a version subproject
  - mixins.json
  - "@Shadow"
  - bytecode patch
  - multi-version mixin
  - Yarn versus Mojmap mixin targets
  - port a Fabric mixin to Mojmap
dependencies: []
version: "1.1.2"
---
...
Routing checks: [references/trigger-evals.json](references/trigger-evals.json).
